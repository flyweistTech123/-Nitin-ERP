...
import { AddRequestTypes, PdcFollowUpStatusesDeleteConfirm } from '../Modals/Modals';
...
const StudentRequestType = () => {
    ...
    const fetchData = useCallback(async () => {
        await getApi(endPoints.getAllRequestTypes(pagination.currentPage, pagination.limit), {
    ...
    const handleDelete = async () => {
        ...
        await Promise.all(
            selectedItems.map(async (itemId) => {
                await deleteApi(endPoints.deleteRequestTypes(itemId), {
                    setLoading,
