...
import { AddComplainType, PdcFollowUpStatusesDeleteConfirm } from '../Modals/Modals';
...
const StudentComplaintType = () => {
    ...
    const fetchData = useCallback(async () => {
        await getApi(endPoints.getAllComplainTypes(pagination.currentPage, pagination.limit), {
    ...
    const handleDelete = async () => {
        ...
        await Promise.all(
            selectedItems.map(async (itemId) => {
                await deleteApi(endPoints.deleteComplainTypes(itemId), {
                    setLoading,
